        ...
        <main className={styles.mainAbout}>
            <div className={styles.divFlex}>
                ...
                <section className={styles.sectionSobre}>
                    ...
                    <p className={styles.pBlue}>Dev Front End</p>
                    <p>Estudo desenvolvimento Web desde 2020.</p>
                    <p>Sou apaixonado em transformar ideias em realidade digital</p>
                    <p>Estudante de desenvolvimento Web Front-End, focado em aplicações dinâmicas e intuitivas, com foco na experiência do usuário.</p>
                </section>
            </div>
